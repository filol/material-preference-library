 ...
 */
public class MaterialPreferenceCheckBoxItem extends MaterialPreferenceItem{
    ...
    public static void setupItem(MaterialPreferenceCheckBoxItemViewHolder holder, MaterialPreferenceCheckBoxItem item, Context context) {
    ...
    public String getDetailString() {
        return "MaterialPreferenceCheckBoxItem{" +
                "text=" + text +
                ", textRes=" + textRes +
                ", subText=" + subText +
    ...
    public MaterialPreferenceCheckBoxItem(MaterialPreferenceCheckBoxItem item) {
        this.id = item.getId();
    ...
    public MaterialPreferenceItem clone() {
        return new MaterialPreferenceCheckBoxItem(this);
    }
    ...
    public MaterialPreferenceCheckBoxItem setText(CharSequence text) {
        this.textRes = 0;
        this.text = text;
        return this;
    }
    ...
    public MaterialPreferenceCheckBoxItem setTextRes(int textRes) {
        this.text = null;
        this.textRes = textRes;
        return this;
    }
    ...
    public MaterialPreferenceCheckBoxItem setSubText(CharSequence subText) {
        this.subTextRes = 0;
        this.subText = subText;
        return this;
    }
    ...
    public MaterialPreferenceCheckBoxItem setSubTextRes(int subTextRes) {
        this.subText = null;
        this.subTextRes = subTextRes;
        return this;
    }
    ...
    public MaterialPreferenceCheckBoxItem setIcon(Drawable icon) {
        this.iconRes = 0;
        this.icon = icon;
        return this;
    }
    ...
    public MaterialPreferenceCheckBoxItem setIconRes(int iconRes) {
        this.icon = null;
        this.iconRes = iconRes;
        return this;
    }
    ...
    public MaterialPreferenceCheckBoxItem setShouldShowIcon(boolean showIcon) {
        this.showIcon = showIcon;
        return this;
    }

    @MaterialPreferenceCheckBoxItem.IconGravity
    public int getIconGravity() {
        return iconGravity;
    }

    public MaterialPreferenceCheckBoxItem setIconGravity(int iconGravity) {
    ...
    public static class MaterialPreferenceCheckBoxItemViewHolder extends MaterialPreferenceItemViewHolder implements CompoundButton.OnCheckedChangeListener {
        ...
        MaterialPreferenceCheckBoxItemViewHolder(View view) {
            super(view);
            this.view = view;
            icon = (ImageView) view.findViewById(R.id.mp_checkbox_image);
            text = (TextView) view.findViewById(R.id.mp_checkbox_text);
            subText = (TextView) view.findViewById(R.id.mp_checkbox_subtext);
            aCheckBox = (CheckBox) view.findViewById(R.id.mp_checkbox);
        }
    ...
    public static class Builder {
        ...
        public Builder setIconGravity(@MaterialPreferenceCheckBoxItem.IconGravity int iconGravity) {
            this.iconGravity = iconGravity;
            return this;
        }
        ...
        public MaterialPreferenceCheckBoxItem build() {
            return new MaterialPreferenceCheckBoxItem(this);
        }
    }
}