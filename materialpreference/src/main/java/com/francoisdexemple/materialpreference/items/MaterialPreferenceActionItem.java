...
public class MaterialPreferenceActionItem extends MaterialPreferenceItem {
    ...
    private MaterialPreferenceActionItem(Builder builder) {
        super();
    ...
    public MaterialPreferenceActionItem(CharSequence text, CharSequence subText, Drawable icon, MaterialPreferenceItemOnClickAction onClickAction) {
        this.text = text;
    ...
    public MaterialPreferenceActionItem(CharSequence text, CharSequence subText, Drawable icon) {
        this.text = text;
        this.subText = subText;
        this.icon = icon;
    }

    public MaterialPreferenceActionItem(int textRes, int subTextRes, int iconRes, MaterialPreferenceItemOnClickAction onClickAction) {
    ...
    public MaterialPreferenceActionItem(int textRes, int subTextRes, int iconRes) {
        this.textRes = textRes;
        this.subTextRes = subTextRes;
        this.iconRes = iconRes;
    }
    ...
    public static MaterialPreferenceItemViewHolder getViewHolder(View view) {
        return new MaterialPreferenceActionItemViewHolder(view);
    }

    public static void setupItem(MaterialPreferenceActionItemViewHolder holder, MaterialPreferenceActionItem item, Context context) {
        ...
        switch (item.getIconGravity()) {
            case MaterialPreferenceActionItem.GRAVITY_TOP:
                params.gravity = Gravity.TOP;
                break;
            case MaterialPreferenceActionItem.GRAVITY_MIDDLE:
                params.gravity = Gravity.CENTER_VERTICAL;
                break;
            case MaterialPreferenceActionItem.GRAVITY_BOTTOM:
    ...
    public String getDetailString() {
        return "MaterialPreferenceActionItem{" +
                "text=" + text +
                ", textRes=" + textRes +
                ", subText=" + subText +
    ...
    public MaterialPreferenceActionItem(MaterialPreferenceActionItem item) {
        this.id = item.getId();
    ...
    public MaterialPreferenceItem clone() {
        return new MaterialPreferenceActionItem(this);
    }

    public CharSequence getText() {
        return text;
    }
    public MaterialPreferenceActionItem setText(CharSequence text) {
        this.textRes = 0;
        this.text = text;
        return this;
    }
    ...
    public MaterialPreferenceActionItem setTextRes(int textRes) {
        this.text = null;
        this.textRes = textRes;
        return this;
    }
    ...
    public MaterialPreferenceActionItem setSubText(CharSequence subText) {
        this.subTextRes = 0;
        this.subText = subText;
        return this;
    }
    ...
    public MaterialPreferenceActionItem setSubTextRes(int subTextRes) {
        this.subText = null;
        this.subTextRes = subTextRes;
        return this;
    }
    ...
    public MaterialPreferenceActionItem setIcon(Drawable icon) {
        this.iconRes = 0;
        this.icon = icon;
        return this;
    }
    ...
    public MaterialPreferenceActionItem setIconRes(int iconRes) {
        this.icon = null;
        this.iconRes = iconRes;
        return this;
    }
    ...
    public MaterialPreferenceActionItem setShouldShowIcon(boolean showIcon) {
    ...
    public MaterialPreferenceActionItem setIconGravity(int iconGravity) {
    ...
    public MaterialPreferenceActionItem setOnClickAction(MaterialPreferenceItemOnClickAction onClickAction) {
        this.onClickAction = onClickAction;
        return this;
    }
    ...
    public MaterialPreferenceActionItem setOnLongClickAction(MaterialPreferenceItemOnClickAction onLongClickAction) {
    ...
    public static class MaterialPreferenceActionItemViewHolder extends MaterialPreferenceItemViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        MaterialPreferenceActionItemViewHolder(View view) {
            super(view);
            this.view = view;
            icon = (ImageView) view.findViewById(R.id.mp_item_image);
            text = (TextView) view.findViewById(R.id.mp_item_text);
            subText = (TextView) view.findViewById(R.id.mp_action_item_subtext);
        }
    ...
    public static class Builder {
        ...
        public Builder setOnClickAction(MaterialPreferenceItemOnClickAction onClickAction) {
            this.onClickAction = onClickAction;
            return this;
        }

        public Builder setOnLongClickAction(MaterialPreferenceItemOnClickAction onLongClickAction) {
            this.onLongClickAction = onLongClickAction;
            return this;
        }

        public MaterialPreferenceActionItem build() {
            return new MaterialPreferenceActionItem(this);
        }
    }
}
