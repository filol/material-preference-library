...
public class MyCustomItem extends MaterialPreferenceItem {
    ...
    public static class MyCustomItemViewHolder extends MaterialPreferenceItemViewHolder implements View.OnClickListener {
